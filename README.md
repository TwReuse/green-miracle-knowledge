...
- **Repo 類別**：知識類別網站（`knowledge-site`），用於維護公開知識、知識母稿、來源、訓練內容、機讀索引與 MkDocs 網站。
- **治理方式**：單人作業治理（`single-person`），目前由 Chinwen 統籌編修、審查、核定與發布。
- **可追溯性**：以來源 ID、版本、差異檢查、自動驗證、Git 提交與核定證據補強同一人兼任多個角色的查核需求。
- **例外邊界**：法定決議、個資、募款、財務與第三方權利仍依協會章程、法令或外部授權辦理。
