...
<div class="gm-action-grid">
  <a class="gm-action-card" href="https://www.reuse.org.tw/index.html">
    <span class="gm-card-icon" aria-hidden="true">↻</span>
    <strong>我要回收電腦</strong>
    <span>查看官網最新回收說明與線上表單</span>
    <em>前往官網 →</em>
  </a>
  <a class="gm-action-card" href="https://www.reuse.org.tw/project.html">
    <span class="gm-card-icon" aria-hidden="true">⌘</span>
    <strong>我要申請再生電腦</strong>
    <span>查看資格、配合事項、授權與保固</span>
    <em>前往申請說明 →</em>
  </a>
  <a class="gm-action-card" href="https://www.reuse.org.tw/Credit_Check.html">
    <span class="gm-card-icon" aria-hidden="true">✓</span>
    <strong>查閱勸募徵信</strong>
    <span>查看官網公開的勸募與結案資料</span>
    <em>查看公開紀錄 →</em>
  </a>
</div>
